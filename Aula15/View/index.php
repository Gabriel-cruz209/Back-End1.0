...
<div class="form-container">
    ...
    <form method="POST">
        ...
        <input type="hidden" name="nome" value="<?php echo htmlspecialchars($bebidaParaEditar->getNome()); ?>">
        <p><strong>Nome:</strong> <?php echo htmlspecialchars($bebidaParaEditar->getNome()); ?></p>
        <p><strong>Categoria:</strong> <?php echo htmlspecialchars($bebidaParaEditar->getCategoria()); ?></p>
        <p><strong>Volume:</strong> <?php echo htmlspecialchars($bebidaParaEditar->getVolume()); ?></p>
